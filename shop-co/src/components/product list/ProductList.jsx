...
const ProductList = (props) => {
   ...
   return (
      <section className="flex justify-center gap-5 overflow-x-scroll w-full scrollBar">
         {
            props.data.map((e, i) => (
               i < props.number ?
                  <div className="flex flex-col gap-4 w-[295px]">
                     <div className="flex-none rounded-[20px] overflow-hidden">
                        <img className="w-full object-contain" src={e.images[0]} alt="" />
                     </div>
                     <div className="flex flex-col gap-2">
                        <div className="Satoshi-Bold text-xl line-clamp-1 h-7">{e.title}</div>
                        <div>
                        ...
                        <div className="Satoshi-Bold text-2xl line-clamp-1 h-8">${e.price}</div>
                     </div>
                  </div> : ''
            ))
         }
